...
import at.edu.ati.webserver.configuration.PropertyConfiguration;
...
public class Webserver {
	...
	public static void main(String[] args) {
		try {
			...
			IServerConfiguration configuration = PropertyConfiguration
					.instance(new File("webserver.cfg"));

			Server server = new Server(configuration, processor);
			while (true) {
	...
	private static void readConfig() throws IOException {
		...
		BufferedInputStream stream = new BufferedInputStream(
				new FileInputStream("webserver.cfg"));
